...
const AddCourse = () => {
  ...
  const addLecture = () => {
    if (!lectureDetails.lectureTitle || !lectureDetails.lectureUrl || !lectureDetails.lectureDuration) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!courseTitle || !courseDescription) {
      return toast.error('Title or Description cannot be empty');
    }
        ...
        {showPopup && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
              ...
              <input type="text" className="mb-2 w-full border rounded py-1 px-2" placeholder="Lecture Title" value={lectureDetails.lectureTitle} onChange={(e) => setLectureDetails({ ...lectureDetails, lectureTitle: e.target.value })} />
              <input type="number" className="mb-2 w-full border rounded py-1 px-2" placeholder="Duration (minutes)" value={lectureDetails.lectureDuration} onChange={(e) => setLectureDetails({ ...lectureDetails, lectureDuration: e.target.value })} />
              <input type="text" className="mb-2 w-full border rounded py-1 px-2" placeholder="Lecture URL" value={lectureDetails.lectureUrl} onChange={(e) => setLectureDetails({ ...lectureDetails, lectureUrl: e.target.value })} />
